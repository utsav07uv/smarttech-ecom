                                                            ...
                                                            <div class="single-product-wrap">
                                                                <div class="product-image banner-hover">
                                                                    <a href="product-details.php" class="pro-img">
                                                                        <img src="images/seller/jbhifi.png" class="img-fluid img1 mobile-img1" alt="p1">
                                                                        <img src="images/seller/jbhifi.png" class="img-fluid img2 mobile-img2" alt="p2">
                                                                    </a>
                                                                </div>
                                                                <div class="product-caption">
                                                                    <div class="product-content">
                                                                        <div class="product-title">
                                                                            <h3><a href="product-details.php">JB Hi-Fi</a></h3>
                                                                        </div>
