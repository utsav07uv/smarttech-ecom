                                            ...
                                            <div class="wishlist-all-pro">
                                                <div class="wishlist-pro">
                                                    <div class="wishlist-pro-image">
                                                        <a href="product.html" data-animate="animate__fadeInUp">
                                                            <img src="img/menu/home-pro-banner1.jpg" class="img-fluid" alt="p-1">
                                                        </a>
                                                    </div>
                                                    <div class="pro-details">
                                                        <h6>
                                                        <a href="product.html" data-animate="animate__fadeInUp">Portable speaker</a>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="qty-item">
                                                    <a href="cart-page.html" class="add-wishlist" data-animate="animate__fadeInUp">Add to cart</a>
                                                    <a href="checkout-style1.html" class="add-wishlist" data-animate="animate__fadeInUp">Buy now</a>
                                                </div>
                                        ...
                                        <div class="wishlist-details">
                                            <div class="wishlist-all-pro">
                                                <div class="wishlist-pro">
                                                    <div class="wishlist-pro-image">
                                                        <a href="product.html" data-animate="animate__fadeInUp">
                                                            <img src="img/menu/home-pro-banner3.jpg" class="img-fluid" alt="p-2">
                                                        </a>
                                                    </div>
                                                    <div class="pro-details">
                                                        <h6>
                                                        <a href="product.html" data-animate="animate__fadeInUp">Ev charging plug</a>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="qty-item">
                                        ...
                                        <div class="wishlist-details">
                                            <div class="wishlist-all-pro">
                                                <div class="wishlist-pro">
                                                    <div class="wishlist-pro-image">
                                                        <a href="product.html" data-animate="animate__fadeInUp">
                                                            <img src="img/menu/home-pro-banner5.jpg" class="img-fluid" alt="p-3">
                                                        </a>
                                                    </div>
                                                    <div class="pro-details" data-animate="animate__fadeInUp">
                                                        <h6>
                                                        <a href="product.html">Verse earphones</a>
                                                        </h6>
                                                    </div>
                                                </div>
                                                <div class="qty-item">
