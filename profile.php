                                    ...
                                    <div class="account-profile">
                                        <div class="pro-img">
                                            <a href="javascript:void(0)" data-animate="animate__fadeInUp">
                                                <img src="images/profile.png" class="img-fluid" alt="testi-1">
                                            </a>
                                        </div>
                                        <div class="profile-text">
                                            <h6 data-animate="animate__fadeInUp">Utsav Rai</h6>
                                            <span data-animate="animate__fadeInUp">Joined August 20, 2025</span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="billing-form">
                                                ...
                                                <ul class="pro-submit">
                                                    <li data-animate="animate__fadeInUp">
                                                        <a href="pro-wishlist.html" class="btn btn-style2 checkout disabled">Update profile</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </form>
