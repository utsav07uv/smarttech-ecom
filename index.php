...
<head>
    ...
    <body>
        ...
        <?php 
        $category_collaps = true;
        include("partiels/header.php");?>
        <!-- main start -->
        <main id="main-content">
           <?php include("partiels/slider.php");?>
            <?php include("partiels/service.php");?>
            <?php include("partiels/banner.php");?>
            <?php include("partiels/top-sellers.php");?>
             <?php include("partiels/recommended.php");?>
            <?php include("partiels/comming-soon.php");?>
            <?php include("partiels/custom-banner.php");?>
            <?php include("partiels/blog.php");?>
            <?php include("partiels/brand-logo.php");?>
        </main>
        <!-- main end -->
                                        ...
                                        <div class="search-box">
                                            ...
                                            <form action="index.php" method="get" class="search-bar">
                                                <div class="form-search">
                                                    <input type="search" name="q" placeholder="Search here" onclick="location.href='search.html'" class="search-input">
                    ...
                    <div class="drawer-footer">
                        ...
                        <div class="drawer-cart-checkout">
                            <div class="cart-checkout-btn">
                                <button type="button" onclick="location. href='checkout-style1.html'" class="btn btn-style">Checkout</button>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="quickview-slider">
                                <div class="swiper gallery-top">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="product-details.php"><img src="img/product/home3-p5.jpg" class="img-fluid" alt="p-1"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="product-details.php"><img src="img/product/home3-p7.jpg" class="img-fluid" alt="p-2"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="product-details.php"><img src="img/product/home3-p9.jpg" class="img-fluid" alt="p-3"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="product-details.php"><img src="img/product/home3-p11.jpg" class="img-fluid" alt="p-4"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="product-details.php"><img src="img/product/home3-p13.jpg" class="img-fluid" alt="p-5"></a>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper gallery-thumbs">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <a href="javascript:void(0)"><img src="img/product/home3-p5.jpg" class="img-fluid" alt="p-1"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="javascript:void(0)"><img src="img/product/home3-p7.jpg" class="img-fluid" alt="p-2"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="javascript:void(0)"><img src="img/product/home3-p9.jpg" class="img-fluid" alt="p-3"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="javascript:void(0)"><img src="img/product/home3-p11.jpg" class="img-fluid" alt="p-4"></a>
                                        </div>
                                        <div class="swiper-slide">
                                            <a href="javascript:void(0)"><img src="img/product/home3-p13.jpg" class="img-fluid" alt="p-5"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
